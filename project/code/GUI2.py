...
# 載入模型
model_path = r"C:/Yolov8/ultralytics/segment/train4/weights/best.pt"
model = YOLO(model_path)

# 顏色設定
colors = {
    "Intact Capsule": (255, 0, 0),
    "Defective Capsule": (0, 0, 255)
}
...
class PillDetectionApp(QWidget):
    def __init__(self):
        ...
        self.pill_label = QLabel("藥物種類: 膠囊")
        ...
        while cap.isOpened():
            ...
            if result.boxes is not None:
                for box in result.boxes:
                    ...
                    if label == "Defective Capsule":
                        detected_label = "1"
                    elif label == "Intact Capsule":
                        detected_label = "0"
